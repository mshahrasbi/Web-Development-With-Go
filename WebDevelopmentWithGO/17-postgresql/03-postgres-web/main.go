...
func booksIndex(res http.ResponseWriter, r *http.Request) {
	if r.Method != "GET" {
...
func booksUpdateProcess(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("UPDATE books SET isbn=$1, title=$2, author=$3, price=$4 WHERE isbn=$1;", bk.Isbn, bk.Title, bk.Author, bk.Price)
