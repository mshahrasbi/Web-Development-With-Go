...
// Package bufio has the Scanner type. The Scanner type "provides a convenient interface
// for reading data". When you have a Scanner type, you can call the SCAN method on it.
...
// this method, you will be given the text from the current token. Here is how you will
// use it:
...
// Use this code to READ from an incoming connection and print the incoming text
// to standard out (the terminal).
